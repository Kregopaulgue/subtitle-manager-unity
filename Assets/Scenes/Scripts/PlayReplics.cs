...
public class PlayReplics : MonoBehaviour {
    ...
    public bool isTopSubtitle = false;
    public bool isBottomSubtitle = true;

    void Start () {
        audioSource = FindObjectOfType<AudioSource>();

        SubtitleManager.Instance.InitializeSubtitleManager(resourceFile);
    ...
    private IEnumerator PlayAudio()
    {
        ...
        audioSource.Play();
        SubtitleManager.Instance.Show(audioSource.clip, isTopSubtitle, isBottomSubtitle);
